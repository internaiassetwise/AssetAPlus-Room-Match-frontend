...
export const UI = {
  ...
  cardFloor: 'Floor',
  cardViewDetails: 'View details for',
  badgeFeatured: 'Popular',
  badgeAvailable: 'Ready to move in',
  badgeSoon: 'Available soon',
  rdHome: 'Home',
  rdRooms: 'Rooms',
  rdLoading: 'Loading room…',
  rdLoadFailed: 'Could not load this room',
  rdTryAgain: 'Please try again',
  rdBackHome: 'Back to home',
  rdCondo: 'Condo',
  rdBedrooms: 'Bedrooms',
  rdBathrooms: 'Bathrooms',
  rdSize: 'Size',
  rdRoomType: 'Room type',
  rdBuilding: 'Building',
  rdFloor: 'Floor',
  rdView: 'View',
  rdViewPool: 'Pool view',
  rdViewGarden: 'Garden view',
  rdViewOutside: 'Outside view',
  rdUnitRooms: '',
  rdUnitSqm: 'sqm',
  rdDetails: 'Details',
  rdAmenities: 'Amenities',
  rdManagedTitle: 'Managed by AssetWise',
  rdManagedBody: 'Free viewings, tenant document checks, a standard contract, and a monthly status report for the owner.',
  rdPerMonth: '/ month',
  rdRentNote: 'Monthly rent, excluding water and electricity',
  rdAvailableFrom: 'Available from',
  rdCall: 'Call',
  rdWantToList: 'Want to list a room?',
  rdTrustNoFee: 'No registration fee',
  rdTrustPayOnSuccess: 'Pay only on success',
  rdTrustStandardContract: 'Standard contract',
  rdReadyToMove: 'Ready to move in',
